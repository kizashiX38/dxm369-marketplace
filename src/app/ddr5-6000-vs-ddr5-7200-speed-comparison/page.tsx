...
const comparisonConfig = COMPARISON_TEMPLATES.ddr5_6000_vs_7200;
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <header className="glass-hero mb-8 p-8 clip-corner-tl glass-corner-accent holographic-sheen">
            ...
            <div className="flex gap-4 mt-6">
              ...
              <a href="/memory" className="px-6 py-3 bg-slate-700/50 border border-slate-600 rounded hover:bg-slate-700/70 text-white font-mono text-sm">
                All RAM
              </a>
            </div>
          </header>
          ...
          <section className="glass-panel rounded-xl p-8 border border-slate-700/50">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <a href="/memory" className="p-4 bg-slate-800/50 rounded hover:bg-slate-800/70 transition">
                <h4 className="font-bold text-white mb-2">→ All RAM Deals</h4>
                <p className="text-slate-400 text-sm">Browse complete RAM lineup</p>
              </a>
